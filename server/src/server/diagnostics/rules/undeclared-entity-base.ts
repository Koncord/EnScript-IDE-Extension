...
- \`severity\`: Diagnostic severity level (default: ERROR)`;
     ...
     * Used by override-related rules
     */
    protected signaturesMatch(method1: MethodDeclNode, method2: MethodDeclNode): boolean {
     ...
     * Used by override-related rules
     */
    protected findOriginalClass(className: string, context: DiagnosticRuleContext): ClassDeclNode | null {
     ...
     * Used by override-related rules
     */
    protected findClassByName(className: string, context: DiagnosticRuleContext): ClassDeclNode | null {
